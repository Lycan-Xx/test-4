...
const PaymentHistory = () => {
 return (
  <main className="flex flex-col">
   <header className="flex flex-col mx-auto justify-between w-full mb-[48px]">
    <div className="flex flex-col">
     <h4 className="font-bold text-[40px]">Payment History.</h4>
     <p className="font-poppins font-light text-[20px] mt-[10px] text-greytext">
      See history of your payment transactions here.
     </p>
    </div>
    <div className="rounded-[16px] bg-gray-50 py-[24px] px-[32px] flex flex-col mx-auto justify-center align-middle w-full">
     <h5 className="text-2xl font-bold leading-[150%] font-lato">
      Account Status
     </h5>
