...
const CreateCVNav = () => {
 ...
 return (
  <main className="flex flex-col md:flex-row justify-between w-full items-center align-middle mb-6">
   <nav className="flex flex-row lg:gap-[6px] gap-[8px] justify-center items-center">
    {CVLinks.map(({ id, text, link }) => {
     ...
     return (
      ...
      >
       <button
        className={`flex text-transparent w-16 h-2 md:h-full md:w-full md:text-gray-700 whitespace-nowrap rounded-[26px] border-[1px] border-gray-300 justify-center items-center md:py-[8px] md:px-[25px] md:text-base text-gray-700 md:font-medium  ${
